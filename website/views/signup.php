...
<body>
    ...
    <form class="first forms d-grid justify-content-center align-items-center" action="../index.php?user=signup" method="post">
        ...
        <!-- Redirect to the last item -->
        <?php if ($productObj->getProductID() != '') { ?>
            <input name="goto" type="hidden" value="<?php echo $productObj->getProductID(); ?>">
        <?php } ?>
